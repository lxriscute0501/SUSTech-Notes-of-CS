...
class CorpusReader:
    ...
    def getNegatives(self, target, size): 
        """
        This function does not consider what current context (outside) words are.
        So there is a risk that the negative samples will contain a context (outside) word.
        To deal with this, you can add manual sanity check outside this function.
        """
        while True:
